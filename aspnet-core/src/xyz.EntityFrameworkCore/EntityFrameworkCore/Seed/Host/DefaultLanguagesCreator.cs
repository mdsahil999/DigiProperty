...
namespace xyz.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly xyzDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = xyzConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(xyzDbContext context)
        {
            _context = context;
        }
