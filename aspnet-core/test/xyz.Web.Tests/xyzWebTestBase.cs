...
{
    public abstract class xyzWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static xyzWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(xyzWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<xyzDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<xyzDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<xyzDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<xyzDbContext, Task<T>> func)
        {
            T result;
